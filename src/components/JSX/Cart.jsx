...
export default function Cart() {
  const { cart, removeFromCart, getTotal, getQuantity, clearCart } =
  ...
  if (!empty) {
    return (
      <div>
        ...
        <div>
          ...
          <button className="btn-purchase" onClick={handleFinalize}>
            Comprar
          </button>
    ...
    return (
      <div>
        <h3>
          Su Orden No. <span>{orderId}</span> ha sido confirmada
        </h3>
        <Link to="/" exact>
